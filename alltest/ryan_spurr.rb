...
class CS253EnumTests < Minitest::Test
    ...
    def test_cs253inject
        ...
        arr = ["a","bb",'ccc',"dddd"]
        myarr = CS253Array.new(arr)
        longest = CS253Array.new(arr).cs253inject do |memo, word|
    ...
    def test_cs253minmax
        #TODO fix min method and minmax method
=begin
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253minmax {|v, x| v <=> x}, arr.minmax {|v, x| v <=> x}
...
=end
    ...
    def test_cs253reverse_each
        ...
        arr1 = []
        arr2 = []
        myarr.cs253reverse_each {|v| v + 1}
        arr.reverse_each {|v| v + 1}.to_a
        assert_equal arr1, arr2
    ...
    def test_cs253slice_after
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253slice_after{|v| v == "you"}, arr.slice_after{|v| v == "you"}.to_a
    ...
    def test_cs253slice_before
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253slice_before{|v| v == "you"}, arr.slice_before{|v| v == "you"}.to_a
...
=begin
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253sort {|v,x| v <=> x }, arr.sort {|v,x| v <=> x }
        ...
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253sort {|v, x| v + x <=> v}, arr.sort {|v, x| v + x <=> v}
=end
    end
    ...
    def test_cs253take_while
        arr = [1,2,3,4,5,6]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253take_while {|i| i%3 == 2} , arr.take_while {|i| i%3 == 2}
        ...
        arr = ["these", "are", "words"]
        myarr = CS253Array.new(arr)
        assert_equal myarr.cs253take_while {|i| i.length%3 == 2} , arr.take_while {|i| i.length%3 == 2}
    end
